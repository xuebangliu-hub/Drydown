...
# 1. Load data
# ===========================================================
area_ratio = np.load(".../crop_pasture/cropland/pasture_sig_acceleration_area_ratio.npy")
production_data = np.load(".../crop_pasture/cropland/pasture_debsity_sig_acceleration_ratio.npy")

CROP_NAMES = ["Cattle", "Horse", "Goat", "Sheep"]
...
# ===========================================================
plt.savefig(
    ".../cropland_pasture/pature_density_effect.jpg",
    bbox_inches='tight',
    dpi=500
)