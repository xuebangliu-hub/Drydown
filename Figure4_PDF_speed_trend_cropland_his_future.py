...
FUT1_PATH = ".../warm_season/SSP585/2025_2060_mean/ensemble_mean_2025_2060_decline_rate.npy"
...
RAINFED_PATH = ".../pasture_cropland/extent/Cropland_100.npy"

X_MIN, X_MAX = 0, 7
N_GRID = 1000

# ===========================================================
# 2. Rainfed cropland mask
# ===========================================================
...
def trend_proportions(trend_mean, sig, mask,
    ...
    mask : ndarray
        Boolean mask for rainfed cropland.
...
ax_main.set_xlabel(
    r'Cropland drydown$_{\mathrm{Speed}}$'
...
plt.savefig(
    save_path + "cropland_Drydown_speed_pdf.jpg",
    dpi=500,
    bbox_inches='tight'
)